...
export default function LearnSellPage() {
  ...
  return (
    <header className="page-header container mx-auto mb-32 px-4">
        <h1 className="page-title text-3xl md:text-5xl leading-tight mt-12 mb-3 md:mb-8 max-w-4xl mx-auto text-center md:text-center">
        Home Selling
      </h1>
